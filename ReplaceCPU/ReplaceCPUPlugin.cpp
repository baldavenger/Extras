...
#define kPluginIdentifier "OpenFX.Yo.ReplaceCPU"
...
public:
    ...
    float hueRotation, float hueRotationGain, float hueMean, float hueRolloff, float satRangeA,
...
class ReplaceCPUPlugin
    : public ImageEffect
{
public:
    /** @brief ctor */
    ReplaceCPUPlugin(OfxImageEffectHandle handle)
        : ImageEffect(handle)
        , _dstClip(0)
        , _srcClip(0)
        , _srcColour(0)
...
/* set up and run a processor */
void
ReplaceCPUPlugin::setupAndProcess(ImageScaler& p_ImageScaler, const RenderArguments &args)
{
	...
	hueRotation, hueRotationGain, hueMean, hueRolloff, satRangeA, satRangeB, satAdjust, satAdjustGain, 
...
void
ReplaceCPUPlugin::render(const RenderArguments &args)
{
...
} // ReplaceCPUPlugin::render

bool
ReplaceCPUPlugin::isIdentity(const IsIdentityArguments &args,
                          Clip * &identityClip,
                          double & /*identityTime*/
                          , int& /*view*/, std::string& /*plane*/)
{
    ...
    return false;
} // ReplaceCPUPlugin::isIdentity

bool
ReplaceCPUPlugin::computeWindow(const OFX::Image* srcImg,
                             double time,
...
void
ReplaceCPUPlugin::setSrcFromRectangle(const OFX::Image* srcImg,
                                   double time,
                                   const OfxRectI &analysisWindow)
{
    double hmean = 0.;
    ...
    endEditBlock();
} // ReplaceCPUPlugin::setSrcFromRectangle

/* set up and run a processor */
void
ReplaceCPUPlugin::setSrcFromRectangleProcess(HueMeanProcessorBase& p_Huemeanprocessor,
...
void
ReplaceCPUPlugin::changedParam(const OFX::InstanceChangedArgs& args,
...
} // ReplaceCPUPlugin::changedParam



/* Override the clip preferences */
void
ReplaceCPUPlugin::getClipPreferences(ClipPreferencesSetter& p_ClipPreferences)
{
...
ReplaceCPUPluginFactory::ReplaceCPUPluginFactory()
    : OFX::PluginFactoryHelper<ReplaceCPUPluginFactory>(kPluginIdentifier, kPluginVersionMajor, kPluginVersionMinor)
{
}

void
ReplaceCPUPluginFactory::describe(OFX::ImageEffectDescriptor &desc)
{
    // basic labels
...
void
ReplaceCPUPluginFactory::describeInContext(ImageEffectDescriptor& desc,
...
ImageEffect* ReplaceCPUPluginFactory::createInstance(OfxImageEffectHandle handle, ContextEnum /*p_Context*/)
{
    return new ReplaceCPUPlugin(handle);
}

void OFX::Plugin::getPluginIDs(PluginFactoryArray& p_FactoryArray)
{
    static ReplaceCPUPluginFactory replaceCPUPlugin;
    p_FactoryArray.push_back(&replaceCPUPlugin);
}
