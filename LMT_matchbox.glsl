//   LMT_Academy_Analytic_3 by Scott Dyer (converted to Matchbox shader from original CTL by Baldavenger)
//
...
const float Aa = 10.5402377416545;
const float B = 0.0729055341958355;

uniform sampler2D front;
uniform float adsk_result_w, adsk_result_h; 
uniform float p_Scale1;
uniform float p_Scale2;
uniform float p_Scale3;
uniform float p_Scale4;
uniform float p_Scale5;
uniform float p_Scale6;
uniform float p_Scale7;
uniform float p_Scale8;
uniform float p_Scale9;
uniform float p_Scale10;
uniform float p_Scale11;
uniform float p_Scale12;
uniform float p_Scale13;
uniform float p_Scale14;
uniform float p_Scale15;
uniform float p_Scale16;
uniform float p_Scale17;
uniform float p_Scale18;
uniform float p_Scale19;
uniform float p_Scale20;
uniform float p_Scale21;
uniform float p_Scale22;
uniform float p_Scale23;
uniform float p_Scale24;
uniform float p_Scale25;
uniform float p_Scale26;
uniform float p_Scale27;
uniform float p_Scale28;
uniform float p_Scale29;
uniform float p_Scale30;
uniform float p_Scale31;

mat3 mult_f_f33(float f, mat3 AA)
{
for( int i = 0; i < 3; ++i )
{
AA[i].x *= f;
...
vec3 mult_f3_f33(vec3 In, mat3 A)
{
vec3 Out;
